...
y_pred = [1, 2, 7, 8, 9, 10]
print("case 1: two correct predictions at the start of the list")
print(f"actual:     {y_actual}")
print(f"prediction: [{colored('1, 2', 'green')}, 7, 8, 9, 10]")
avg_p_at_k = average_precision_at_k(y_actual, y_pred)
print(
    f"Avg Precision@6: ({avg_p_at_k[1][0]} + {avg_p_at_k[1][1]})/{avg_p_at_k[2]} = {avg_p_at_k[0]}\n"
)

y_actual = [1, 2, 3, 4, 5, 6]
y_pred = [7, 1, 3, 4, 8, 9]
print("case 2: two correct predictions plus relevant item in wrong position (before)")
print(f"actual:     {y_actual}")
print(
...
avg_p_at_k = average_precision_at_k(y_actual, y_pred)
print(
    f"Avg Precision@6: ({avg_p_at_k[1][0]} + {avg_p_at_k[1][1]} + {avg_p_at_k[1][2]})/{avg_p_at_k[2]} = {avg_p_at_k[0]}\n"
)

y_actual = [1, 2, 3, 4, 5, 6]
y_pred = [7, 2, 8, 4, 9, 10]
print("case 3: predictions for ranks 2 and 4 are correct")
print(f"actual:     {y_actual}")
...
y_actual = [1, 2, 3, 4, 5, 6]
y_pred = [7, 8, 3, 4, 1, 9]
print("case 4: two correct predictions plus relevant item in wrong position (after)")
print(f"actual:     {y_actual}")
print(
...
y_actual = [1, 2, 3, 4, 5, 6]
y_pred = [7, 8, 3, 4, 9, 10]
print("case 5: two correct predictions in the middle of the list")
print(f"actual:     {y_actual}")
...
y_actual = [1, 2, 3, 4, 5, 6]
y_pred = [7, 8, 9, 0, 5, 6]
print("case 6: two correct predictions at the end of the list")
print(f"actual:     {y_actual}")
...
print("case 7: none of the predictions are correct")
print(f"actual:     {y_actual}")
print(f"prediction: {y_pred}")
print(f"Avg Precision@6: {average_precision_at_k(y_actual, y_pred)[0]}\n")
