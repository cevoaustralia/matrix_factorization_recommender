...
IN_PRODUCTS_FILENAME = "./products.yaml"
IN_USERS_FILENAMES = ["./users.json.gz", "./cstore_users.json.gz"]
...
out_items_filename = f"./items.csv"
out_users_filename = f"./users.csv"
out_interactions_filename = f"./interactions.csv"
...
def generate_user_items(
    out_users_filename, out_items_filename, in_users_filenames, in_products_filename
):
...
if __name__ == "__main__":
    ...
    users_df, products_df = generate_user_items(
        out_users_filename, out_items_filename, IN_USERS_FILENAMES, IN_PRODUCTS_FILENAME
    )
